...
class Classifier_RESNETCNN:
	...
	def build_model(self, inputA_shape, inputB_shape, nb_classes, n_feature_maps=64):
		...
		conv3B = keras.layers.Activation(activation='relu')(conv1B)

		pooling_layerB = keras.layers.GlobalAveragePooling1D()(conv3B)

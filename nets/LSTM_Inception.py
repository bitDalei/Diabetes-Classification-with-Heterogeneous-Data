...
class Classifier_LSTMINCEPTION:
	...
	def build_model(self, inputA_shape, inputB_shape, nb_classes, n_feature_maps=64):
		...
		# combine
		reshape_layer = keras.layers.Reshape((577*nb_classes,))(modelA.output)
		...
		if self.flag_att == 1:
			...
			conv1 = weight * combined
			combined = keras.layers.Conv1D(128, kernel_size=8, padding='same')(conv1)
